...
import truentLogo from "../assets/truent-logo.png";
...
const Education = () => {
  ...
  const coursesContent = [
    ...
    },
    {
      ...
      linkDiploma:
        "https://pub.coderhouse.com/legacy-certificates/66c1eefeb45e2e10098434b0?lang=es",
      isExperience: false,
    },
    {
      title: {
      ...
      diploma: sqlDiploma,
      linkDiploma:
        "https://pub.coderhouse.com/certificates/73e70169-d190-46af-9a89-409da26ecc89?v=1",
      isExperience: false,
    },
    {
      title: {
      ...
      linkDiploma:
        "https://pub.coderhouse.com/certificates/2ed3c39d-8397-4fb8-8990-448f1d900b9f?v=1",
      isExperience: false,
    },
  ];
  ...
  const experienceContent = [
    {
      ...
      linkDiploma:
        "https://www.credential.net/7cd650b2-c6f7-4c33-940d-68b7a2470f20#acc.6QeEcWiR",
      isExperience: false,
    },
    {
      title: {
  ...
  return (
    <div className="education-container">
      ...
      {universityContent.map((university) => {
        if (university.isExperience) {
          return (
            <ExperienceInfo
              ...
              startedIn={university.startedIn}
              finishedIn={university.finishedIn}
            />
          );
        } else {
          return (
            <EducationInfo
              ...
              linkDiploma={university.linkDiploma}
              startedIn={university.startedIn}
              finishedIn={university.finishedIn}
            />
          );
        ...
        if (course.isExperience) {
          return (
            <ExperienceInfo
              ...
              startedIn={course.startedIn}
              finishedIn={course.finishedIn}
            />
          );
        } else {
          return (
            <EducationInfo
              ...
              linkDiploma={course.linkDiploma}
              startedIn={course.startedIn}
              finishedIn={course.finishedIn}
            />
          );
        ...
        if (experience.isExperience) {
          return (
            <ExperienceInfo
              ...
              finishedIn={experience.finishedIn}
            />
          );
        } else {
          return (
            <EducationInfo
              ...
              linkDiploma={experience.linkDiploma}
              startedIn={experience.startedIn}
              finishedIn={experience.finishedIn}
            />
          );
